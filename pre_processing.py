...
from tagger_module import tag_encoder, extract_extra_features
...
def convert_example_to_spans(examples, 
    ...
    map_features = extra_features_names.map_features   
    ...
    for doc_index, (doc_tokens, doc_labels) in enumerate(examples):
        ...
        extra_features = extract_extra_features(doc_tokens, extra_features_names.features,
                                                scenario)
